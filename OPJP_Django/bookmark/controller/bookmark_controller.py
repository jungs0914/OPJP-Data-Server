...
class BookmarkController(viewsets.ViewSet):
    ...
    def requestCreateBookmark(self, request):
        ...
        try:
            ...
            updatedBookmark = self.bookmarkService.createBookmark(accountId, bookmark)
            if updatedBookmark is not None:
                return JsonResponse(
                    {"message": "북마크에 도서가 투가되었습니다.", "success": True},
    ...
    def requestListBookmark(self, request):
        ...
        try:
            ...
            bookmarkList, totalItems = self.bookmarkService.listBookmark(accountId, page, perPage)
