...
#         return cls.__instance
#
#     def crwalBookData(self):
#         print(
#             "Checking attributes of BookServiceImpl instance: ", dir(self)
#         )
#         print(
...
#         print(f"updateBookList: {updateBookList}")
#
#         # 업데이트 실행
#         if updateBookList:
#             self.__updateExistingBooks(updateBookList)
#             return True
#
...
#         else:
#             print("bookDescriptionList is empty.")
#
#         return update_books
#
#     # Private Method 3: 기존 데이터 업데이트
#     def __updateExistingBooks(self, updateBookList):
#         for bookData in updateBookList:
#             self.__bookRepository.save(bookData)
#             print(
#                 f"업데이트된 도서 데이터: {bookData['bookDescription']}"
#             )